...
// doh represents a plugin instance that can proxy requests to another (DNS) server via doh protocol.
...
func (g *doh) ServeDNS(ctx context.Context, w dns.ResponseWriter, r *dns.Msg) (int, error) {
...
func (g *doh) Name() string { return "doh" }

// Len returns the number of configured proxies.
func (g *doh) len() int { return len(g.proxies) }

func (g *doh) match(state request.Request) bool {
...
func (g *doh) isAllowedDomain(name string) bool {
